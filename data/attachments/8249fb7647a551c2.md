...
- Name: mobile/home.spec.ts >> Mobile nav menu (M-GLB-121–131) >> M-GLB-125 New Arrivals links directly to /category/new-arrivals
- Location: tests/mobile/home.spec.ts:199:7
...
Call log:
  - waiting for locator('nav[aria-label*="Mobile navigation" i]').getByRole('link', { name: 'New Arrivals' })
