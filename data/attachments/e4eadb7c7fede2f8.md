...
- Name: mobile/plp.spec.ts >> Mobile PLP refinements (M-PLP-110–114) >> M-PLP-113 filters panel: Shop by Availability expanded by default; Price collapsed
- Location: tests/mobile/plp.spec.ts:132:7
...
Locator:  getByText(/Price/i).first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByText(/Price/i).first()
    12 × locator resolved to <option value="price-low-to-high">Price Low To High</option>
...
- main:
  ...
  - group "Quick category filters":
    ...
    - button "Tops"
  - region "Filters":
    - heading "Shop by Availability" [level=3]:
      - button "Shop by Availability" [expanded]
    - checkbox "Filter Products by Store Availability at Select Store"
    - text: In stock at
    - button "Select Store"
