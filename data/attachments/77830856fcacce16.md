...
- Name: desktop/plp.spec.ts >> Shared Product Card on PLP (CARD-101–116) >> CARD-103 category line is shown on PLP cards
- Location: tests/desktop/plp.spec.ts:214:7
...
Locator: locator('[class*="product-card"]').first().locator('p.text-muted-foreground, p[class*="muted"]').nth(1)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*="product-card"]').first().locator('p.text-muted-foreground, p[class*="muted"]').nth(1)
