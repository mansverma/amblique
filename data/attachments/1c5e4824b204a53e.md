...
- Name: mobile/home.spec.ts >> Mobile nav menu (M-GLB-121–131) >> M-GLB-122 menu control changes to a close control while panel is open
- Location: tests/mobile/home.spec.ts:162:7
...
Locator: locator('header').getByRole('button', { name: /close menu/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('header').getByRole('button', { name: /close menu/i })
