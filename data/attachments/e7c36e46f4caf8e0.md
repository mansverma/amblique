...
Call log:
  ...
  - waiting for getByText(/Timeless craftsmanship meets contemporary style/)
    4 × locator resolved to <p class="order-1 text-sm font-normal leading-5 mb-2 whitespace-pre-line text-muted">Timeless craftsmanship meets contemporary style i…</p>
