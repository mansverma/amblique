...
- Name: api/search.spec.ts >> Search API – Women category >> PLP-111 availability refinement is present
- Location: tests/api/search.spec.ts:61:7

# Error details

```
Error: availability refinement absent
