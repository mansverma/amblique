...
- Name: api/products.spec.ts >> Product card API fields >> CARD-109a/M-CARD-109a free delivery promotion exists on products
- Location: tests/api/products.spec.ts:59:7

# Error details

```
Error: No free delivery promotion found on any of the first 3 products
