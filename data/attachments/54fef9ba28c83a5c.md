...
Call log:
  ...
  - waiting for locator('[aria-roledescription="slide"][aria-hidden="false"]').or(locator('[role="group"][aria-label*="1"]')).first().locator('img').first()
    3 × locator resolved to <img loading="eager" fetchpriority="high" class="w-full h-full object-cover" alt="Women's Slacks Jackets and Purses" src="/mobify/bundle/1/client/images/hero-01.webp"/>
