...
- Name: mobile/plp.spec.ts >> Mobile product card (M-CARD-101–115) >> M-CARD-101/104 image and product name link to PDP
- Location: tests/mobile/plp.spec.ts:204:7
...
Call log:
  - waiting for locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]').first().locator('a[href*="/product/"]').first()
