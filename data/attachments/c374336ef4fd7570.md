...
- Name: mobile/home.spec.ts >> Mobile nav menu (M-GLB-121–131) >> M-GLB-125 Women, Men, Kids carry chevrons; New Arrivals does not
- Location: tests/mobile/home.spec.ts:189:7
...
Locator: locator('nav[aria-label*="Mobile navigation" i]').getByRole('button', { name: /expand Women/i })
Expected: attached
Timeout: 5000ms
