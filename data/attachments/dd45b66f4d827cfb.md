...
- Name: mobile/home.spec.ts >> Mobile featured products (M-HOME-201–208) >> M-HOME-203 carousel region is labelled "Featured Products carousel"
- Location: tests/mobile/home.spec.ts:361:7
...
Locator: getByRole('region', { name: /featured products carousel/i }).or(locator('[aria-label*="Featured Products carousel"]')).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('region', { name: /featured products carousel/i }).or(locator('[aria-label*="Featured Products carousel"]')).first()
