...
- Name: desktop/home.spec.ts >> Home – Style for Real Life tiles (HOME-301–308) >> HOME-301 section heading is "Style for Real Life"
- Location: tests/desktop/home.spec.ts:324:7
...
Locator: getByRole('heading', { name: 'Style for Real Life' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Style for Real Life' }).first()
