...
- Name: desktop/plp.spec.ts >> PLP refinements (PLP-109–113) >> PLP-110 Filters control exposes the refinement panel
- Location: tests/desktop/plp.spec.ts:116:7
...
Locator: getByRole('button', { name: /filters/i })
Expected: visible
Timeout: 5000ms
