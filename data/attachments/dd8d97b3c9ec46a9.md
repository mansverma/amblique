...
- Name: desktop/plp.spec.ts >> PLP sort control (PLP-106–108) >> PLP-106/107 sort control labelled "Sort by:" with all eight options
- Location: tests/desktop/plp.spec.ts:71:7
...
Locator: getByText('Sort by:').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Sort by:').first()
