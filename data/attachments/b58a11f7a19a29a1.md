...
- Name: mobile/home.spec.ts >> Mobile collection banners (M-HOME-401–406) >> M-HOME-404 banner CTA is "EXPLORE COLLECTION" on both banners
- Location: tests/mobile/home.spec.ts:466:7
...
Locator: getByText('EXPLORE COLLECTION').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('EXPLORE COLLECTION').first()
    3 × locator resolved to <a data-slot="button" data-size="default" data-discover="true" data-variant="default" aria-label="Explore collection: women's" href="/MarketStreet/en-US/category/womens" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ui transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring focus-visible:ring-[3px] aria-i…>EXPLORE COLLECTION</a>
