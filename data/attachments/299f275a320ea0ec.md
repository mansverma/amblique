...
- Name: mobile/plp.spec.ts >> Mobile PLP grid and pagination (M-PLP-115–119) >> M-PLP-117 page shows 12 product cards
- Location: tests/mobile/plp.spec.ts:173:7
...
Locator:  locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]')
Expected: 12
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]')
