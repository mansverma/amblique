...
- Name: mobile/home.spec.ts >> Mobile global header (M-GLB-101–109) >> M-GLB-104 utility controls are: Find a Store, Sign In, Wishlist, Mini cart, Menu
- Location: tests/mobile/home.spec.ts:99:7
...
Locator: locator('header').first().getByRole('button', { name: /open menu|menu/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('header').first().getByRole('button', { name: /open menu|menu/i })
