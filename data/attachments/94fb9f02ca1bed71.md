...
Call log:
  ...
  - waiting for getByText('WOMEN').first()
    - locator resolved to <button data-state="closed" aria-expanded="false" data-has-submenu="true" data-radix-collection-item="" data-slot="navigation-menu-trigger" id="radix-_R_2qnehj5_-trigger-radix-_R_4aeqnehj5_" aria-controls="radix-_R_2qnehj5_-content-radix-_R_4aeqnehj5_" class="group inline-flex h-9 w-max items-center justify-center rounded-ui bg-transparent px-4 py-2 hover:bg-header-menu-hover-background hover:text-[var(--header-menu-hover-foreground)] focus:bg-header-menu-hover-background focus:text-[var(--header-menu…>Women</button>
    3 × unexpected value "hidden"
