...
- Name: api/basket.spec.ts >> Basket integrity – M-QA-106 >> M-QA-106 newly created guest basket contains zero product items
- Location: tests/api/basket.spec.ts:29:7
