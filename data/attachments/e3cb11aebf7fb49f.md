...
- Name: mobile/home.spec.ts >> Mobile hero carousel (M-HOME-101–111) >> M-HOME-108 carousel auto-advances without user interaction
- Location: tests/mobile/home.spec.ts:309:7
...
Locator: getByRole('heading', { name: 'The New Season' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'The New Season' }).first()
