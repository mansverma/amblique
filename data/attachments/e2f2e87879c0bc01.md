...
- Name: api/basket.spec.ts >> Basket integrity – M-QA-106 >> M-QA-106 basket remains empty after read-only product search (no implicit add)
- Location: tests/api/basket.spec.ts:34:7
