...
- Name: desktop/plp.spec.ts >> PLP page structure (PLP-101–105) >> PLP-104 breadcrumb is "Home > Women"; Home links to home page
- Location: tests/desktop/plp.spec.ts:53:7
...
Locator: getByRole('navigation', { name: /breadcrumb/i }).or(locator('[aria-label*="breadcrumb" i]')).first().getByText('Women')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('navigation', { name: /breadcrumb/i }).or(locator('[aria-label*="breadcrumb" i]')).first().getByText('Women')
