...
- Name: mobile/plp.spec.ts >> Mobile product card (M-CARD-101–115) >> M-CARD-106 star rating and review count are present
- Location: tests/mobile/plp.spec.ts:224:7
...
Locator: locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]').first().getByRole('group').filter({ hasText: /stars|reviews/i }).or(locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]').first().locator('[aria-label*="stars" i]')).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]').first().getByRole('group').filter({ hasText: /stars|reviews/i }).or(locator('[class*="product-card"], [class*="ProductCard"], [data-product-id]').first().locator('[aria-label*="stars" i]')).first()
