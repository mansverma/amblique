...
- Name: desktop/home.spec.ts >> Home – Featured Products carousel (HOME-201–206) >> HOME-201 section heading is "Featured Products"
- Location: tests/desktop/home.spec.ts:275:7
...
Locator: getByRole('heading', { name: 'Featured Products' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Featured Products' })
