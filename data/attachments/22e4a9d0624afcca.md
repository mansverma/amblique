...
- Name: desktop/home.spec.ts >> Home – Featured Products carousel (HOME-201–206) >> HOME-202 "Shop all" link targets /category/root
- Location: tests/desktop/home.spec.ts:279:7
...
Locator: getByRole('link', { name: /shop all/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /shop all/i })
