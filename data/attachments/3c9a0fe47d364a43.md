...
- Name: mobile/plp.spec.ts >> Mobile PLP sort (M-PLP-107–109) >> M-PLP-108 sort control has eight options in specified order
- Location: tests/mobile/plp.spec.ts:70:7
