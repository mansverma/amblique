...
- Name: desktop/home.spec.ts >> Global header – GLB-101–110 >> GLB-110 mini cart shows item count; empty state exposes 0
- Location: tests/desktop/home.spec.ts:182:7
...
Call log:
  - waiting for locator('header').getByRole('link', { name: /cart|basket/i }).or(locator('header [aria-label*="cart" i]')).first()
