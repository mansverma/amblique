...
- Name: desktop/plp.spec.ts >> PLP page structure (PLP-101–105) >> PLP-103 result summary reads "{n} products available"; Women returns 36
- Location: tests/desktop/plp.spec.ts:49:7
...
Locator: getByText(/36 products available/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/36 products available/i)
