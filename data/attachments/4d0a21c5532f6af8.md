...
- Name: mobile/home.spec.ts >> Mobile nav menu (M-GLB-121–131) >> M-GLB-129 Men expands to 9 subcategories matching spec
- Location: tests/mobile/home.spec.ts:234:7
...
Call log:
  - waiting for locator('nav[aria-label*="Mobile navigation" i]').getByRole('button', { name: /expand men/i })
