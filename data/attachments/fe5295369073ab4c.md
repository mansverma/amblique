...
Call log:
  ...
  - waiting for getByText(/Discover our curated collection of sophisticated footwear/)
    2 × locator resolved to <p class="order-1 text-sm font-normal leading-5 mb-2 whitespace-pre-line text-muted">Discover our curated collection of sophisticated …</p>
