...
- Name: mobile/home.spec.ts >> Mobile nav menu (M-GLB-121–131) >> M-GLB-130 Kids expands to 6 subcategories matching spec
- Location: tests/mobile/home.spec.ts:243:7
...
Call log:
  - waiting for locator('nav[aria-label*="Mobile navigation" i]').getByRole('button', { name: /expand kids/i })
