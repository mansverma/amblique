...
- Name: mobile/plp.spec.ts >> Mobile PLP refinements (M-PLP-110–114) >> M-PLP-112 Filters panel expands inline in page flow (not a drawer, overlay or modal)
- Location: tests/mobile/plp.spec.ts:115:7
...
Call log:
  - waiting for locator('[class*="product-grid"], [class*="ProductGrid"]').first()
