...
- Name: desktop/home.spec.ts >> Global header – GLB-101–110 >> GLB-109 Wishlist links to /MarketStreet/en-US/wishlist
- Location: tests/desktop/home.spec.ts:176:7
...
Locator: locator('header').getByRole('link', { name: /wishlist/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('header').getByRole('link', { name: /wishlist/i })
