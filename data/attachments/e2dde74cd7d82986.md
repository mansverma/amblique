...
- Name: desktop/home.spec.ts >> Global header – GLB-101–110 >> GLB-105b Kids flyout lists 6 subcategories with correct href pattern
- Location: tests/desktop/home.spec.ts:146:7
...
Call log:
  - waiting for locator('[data-slot="navigation-menu-trigger"]:visible').filter({ hasText: /\bkids\b/i }).first()
