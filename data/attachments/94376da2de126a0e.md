...
- Name: mobile/plp.spec.ts >> Touch interactions (M-TCH-104–106) >> M-TCH-104 horizontal swipe on a carousel does not prevent vertical page scrolling
- Location: tests/mobile/plp.spec.ts:295:7
