...
- Name: desktop/home.spec.ts >> Home – Hero carousel (HOME-101–111) >> HOME-108/109 dot indicators (×4) and Previous / Next controls are present
- Location: tests/desktop/home.spec.ts:200:7
...
Locator: getByRole('button', { name: /previous|prev/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /previous|prev/i }).first()
