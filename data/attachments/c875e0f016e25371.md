...
- Name: mobile/home.spec.ts >> Mobile global header (M-GLB-101–109) >> M-GLB-109 menu control is labelled "Open menu"; no horizontal nav bar is shown
- Location: tests/mobile/home.spec.ts:132:7
...
Locator: locator('header').getByRole('button', { name: /open menu/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('header').getByRole('button', { name: /open menu/i })
