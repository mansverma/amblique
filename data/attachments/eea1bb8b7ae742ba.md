...
- Name: mobile/plp.spec.ts >> Mobile PLP refinements (M-PLP-110–114) >> M-PLP-110 nine category refinement chips are always visible outside the filters panel
- Location: tests/mobile/plp.spec.ts:91:7
...
Locator: getByRole('button', { name: 'Accessories' }).or(getByRole('link', { name: 'Accessories' })).first()
Expected: visible
Timeout: 5000ms
