...
- Name: desktop/home.spec.ts >> Home – Collection banners (HOME-401–406) >> HOME-404 CTA has accessible name that includes the destination category
- Location: tests/desktop/home.spec.ts:407:7
...
Locator: getByRole('link', { name: /explore collection: women/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /explore collection: women/i })
